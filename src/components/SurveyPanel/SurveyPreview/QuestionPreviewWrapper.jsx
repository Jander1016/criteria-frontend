...
class QuestionPreviewWrapper extends React.Component {
  render() {
    ...
    const QuestionComponent = questionMap[question.type](this.props);
    const classNames = isActive ? 'active question clearfix' : 'question clearfix';
